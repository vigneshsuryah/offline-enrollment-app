...
var urlsToCache = [
  ...
  '/static/style.css',
  '/static/script.js',
  "/static/plugins/bootstrap.css",
  "/static/plugins/jquery.min.js",
  "/static/plugins/bootstrap.js"
];
...
self.addEventListener('fetch', function(event) {
  ...
  // I have proof
  console.log('request url : ', event.request.clone().url)
...
self.addEventListener('sync', function (event) {
  console.log('now online : ' + event.tag);
  if (event.tag === 'test-tag-from-devtools') { // event.tag name checked here must be the same as the one used while registering sync
    event.waitUntil(
